...
* **Как вы относитесь к управляемым инцидентам - диагностическим, специальным?** Мы не считаем эти диагностические инциденты таковыми, у нас есть "опрессовка", этакие учения, например, отключение графита на одном дата центре. Это контролируемый инцидент, смотрим в реальном времени. От него остается свой артефакт, а в архив он не попадает. 
* **Этот процесс носит характер энтузиазма или есть централизация и ответственные? Опыт применяется на все проекты?** Мы, инфраструктурная команда, мы не зарабатываем деньги, поэтому для нас важно, чем заниматься, не чем интересно, а что принесет пользу. Эта практика нам помогает понять, чем заниматься. Там мы понимаем, что мы принесли пользу. 
* **Как правило в продуктовых командах есть саппорт, программисты и эксплуатация. Кто пишет постмортемы?** Тот, кто ответственен за то, что продукт работает, продуктовая команда. Техподдержка может быть одним из каналов, через который мы узнаем о проблеме. 
